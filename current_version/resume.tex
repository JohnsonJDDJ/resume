...
\begin{minipage}[t]{0.73\textwidth}
    ...
    \section{Research}
        \longitem{ML Engineer}{}{Project AEI - Koer A.I., Inc.}{01/2022 - Now}
        \itemdetails{
    ...
    \section{Projects}
        \longitem{Zilean}{}{Data Mining and ML in Python}{05/2022 - Now}
        \itemdetails{
            Predicted League of Legends match outcome using match statistic snapshots before the 16 minute mark. Data fetched through interacting with the Riot API. Meanwhile, built an installable python package "zilean" for processing match data.
        }
        ...
        \itemdetails{
            Predicted Genshin Impact's damage calculation algorithm by building a basic linear model, then displayed the result using R ShinyApp. Data collected from in-game simulations. Used the model to wrote game tutorials receiving 50,000+ likes. 
        }
        \longitem{MineRift}{}{MiniGame Development}{Start Date 2 - End Date 2}
        \itemdetails{
            Built a Minecraft minigame that imitates the Summoner's Rift in League of Legends.
        }
\end{minipage}
\end{document}